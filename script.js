...

{
  ...
  if (normalType === "BigTime") {
    ...
    normalVideo =
    "https://files.catbox.moe/hbz2gs.mp4";
  ...
  if (normalType === "Epic") {
    ...
    normalVideo =
    "https://files.catbox.moe/9rhc5y.mp4";

  } else

  if (normalType === "ShowTime") {

    normalVideo =
    "https://files.catbox.moe/cuncbk.mov";
  ...
  if (doubleRare === true) {
    ...
    doubleVideo =
    "https://files.catbox.moe/a36f8c.mp4";
...
function startConfirmGacha() {
  ...
  const gachaSound = new Audio(
  "https://files.catbox.moe/jqfxyq.mp3");
...
function updateBannerImages() {
  ...
  document.getElementById(
  "bannerType").
  innerHTML = bannerType;

  document.getElementById(
  "bannerTitle").
  innerHTML = bannerTitle;
